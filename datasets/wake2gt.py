...
def convert_swim_gt(gt_path, dst_path, eval_difficult=False):
    ...
    with open(gt_path, 'r') as f:
        files = [x.strip().replace('.jpg', '.xml').replace('JPEGImages', 'Annotations') for x in f.readlines()]
...
if __name__ == "__main__":
    gt_path = '/home/lab/libr/obb-RetinaNet/wave_dataset/test.txt'
    dst_path = '/home/lab/libr/obb-RetinaNet/datasets/evaluate/ground-truth'
